...
| [050](050-register-github-app-secrets.md) | Wire Synapse GitHub App secrets into the server | P1 | M | - | TODO (issue #102; first hosted-SaaS unblocker: GitHub App registration runbook + server env loader, no OAuth/install routes yet) |
